...
(function () {
  ...
  var renderLodge = function (arr) {
    ...
    lodgeElement.querySelector('.lodge__price').textContent = arr.offer.price + PRICE_END;
    ...
    for (var i = 0; i < userFeatures.length; i++) {
      ...
      newElement.className = 'feature__image ' + 'feature__image--' + userFeatures[i];
      lodgeElement.querySelector('.lodge__features').appendChild(newElement);
    }
